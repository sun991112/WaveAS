...
def build_argparser():
    ...
    parser.add_argument("--waveas_diversity_lambda", type=float, default=1e-2)
    parser.add_argument("--waveas_wavelet_energy_lambda", type=float, default=1e-2)
    parser.add_argument("--waveas_wavelet_balance_lambda", type=float, default=1e-1)
    parser.add_argument("--waveas_wavelet_target_ratio", type=float, default=0.25)
